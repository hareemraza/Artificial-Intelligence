...
class PriorityQueue:
    """
      ...
      For example, in A* search, you want to access the child with lowest 
    ...
    def item_present_with_higher_priority(self, item, priority):
        # returns (index and count) of item in heap if item is already in 
        # Queue yet with higher priority (or cost). 
        # Else returns None
        for index, (p, c, i) in enumerate(self.heap):
            if i[0] == item[0]: # at index 0 of item is 'node'.  
                if priority < p:
                    return index, c
        return None
    ...
    def Update_priority(self, item, priority, index, count):
        ...
        # Note the args this function takes, and values that 'item_present_with_higher_priority'
        # returns. 
        del self.heap[index]
